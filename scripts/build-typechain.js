...
async function buildTypechain() {
  ...
  mergeEvents({ src: 'OpenTermLoanV2Refinancer.abi.json', dst: 'OpenTermLoanV2.abi.json' })
  mergeEvents({ src: 'FixedTermLoanRefinancer.abi.json', dst: 'FixedTermLoan.abi.json' })
  mergeEvents({ src: 'FixedTermLoanV6Refinancer.abi.json', dst: 'FixedTermLoanV6.abi.json' })
